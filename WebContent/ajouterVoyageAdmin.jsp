		...
		<div class="wrap-contact100">
			<form action = "controleur.php" method = post>
				...
				<div class="wrap-input100 validate-input" data-validate="Required">
					...
					<input class="input100" type="text" name="nomVoy" placeholder="Entrer Le Nom">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate="Required">
					...
					<input class="input100" type="date" name="check-in-v">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Required">
					<span class="label-input100">Check-Out</span>
					<input class="input100" type="date" name="check-out-v">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Required">
					<span class="label-input100">Moyen Transport</span>
					<input class="input100" type="text" name="moyTrans" placeholder="Entrer Le Moyen de Transport">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Required">
					<span class="label-input100">Prix</span>
					<input class="input100" type="number" name="prixVoy" placeholder="Entrer Le Prix">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input">
					...
					<input class="input100" type="number" name="qteVoy"  placeholder="Entrer La Quantité">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input">
					<span class="label-input100">Nombre Adultes</span>
					<input class="input100" type="number" name=nbrAdul placeholder="Nombre max d'adultes">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input">
					<span class="label-input100">Nombre Enfants</span>
					<input class="input100" type="number" name="nbrEnf" placeholder="Nombre max d'enfants">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Required">
					<span class="label-input100">Nom Hôtel</span>
					<input class="input100" type="text" name="nomHot" placeholder="Entrer Le Nom De L'Hotel">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 input100-select">
					...
					<div>
						<select class="selection-2" name="nbrEtoi">
				...
				<div class="wrap-input100 validate-input" >
					...
					<textarea class="input100" name="comm" placeholder="Votre commentaire ici"></textarea>
					<span class="focus-input100"></span>
				</div>
