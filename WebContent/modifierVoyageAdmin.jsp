...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form action = "modifier.do" method = post>
				<span class="contact100-form-title">
					Modification Voyage
				</span>
				
				<div class="wrap-input100 validate-input" data-validate="Required">
					<span class="label-input100">N# Voyage</span>
					<input class="input100" type="number" name="numVoy"  value="${num}" readonly>
					<span class="focus-input100"></span>
				</div>
				<div class="wrap-input100 input100-select">
					<span class="label-input100">Destination Voyage</span>
					<div>
						<select class="selection-2" name="pays">
				...
				<div class="wrap-input100 validate-input" data-validate="Required">
					<span class="label-input100">Nom Voyage</span>
					<input class="input100" type="text" name="nomVoy" value="${nom}">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 input100-select">
					<span class="label-input100">Type Voyage</span>
					<div>
						<select class="selection-2" name="type_voy">
				...
				<div class="wrap-input100 validate-input" data-validate="Required">
					...
					<input class="input100" type="date" name="check-in-v" value="${checkin}">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Required">
					<span class="label-input100">Check-Out</span>
					<input class="input100" type="date" name="check-out-v" value="${checkout}">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Required">
					<span class="label-input100">Moyen Transport</span>
					<input class="input100" type="text" name="moyTrans" value="${moy}">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Required">
					<span class="label-input100">Prix</span>
					<input class="input100" type="number" name="prixVoy" value="${prix}">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input">
					<span class="label-input100">Quantité Offre</span>
					<input class="input100" type="number" name="qteVoy"  value="${qte}">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input">
					<span class="label-input100">Nombre Adultes</span>
					<input class="input100" type="number" name=nbrAdul value="${nadults}">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input">
					<span class="label-input100">Nombre Enfants</span>
					<input class="input100" type="number" name="nbrEnf" value="${nenfants}">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Required">
					<span class="label-input100">Nom Hôtel</span>
					<input class="input100" type="text" name="nomHot" value="${hotel}">
					<span class="focus-input100"></span>
				</div>
				<div class="wrap-input100 validate-input" data-validate="Required">
					<span class="label-input100">Nombre D'Etoiles Hotel</span>
					<input class="input100" type="number" name="nbrEtoi" value="${etoiles}">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" >
					<span class="label-input100">Commentaire (optionnel)</span>
					<textarea class="input100" name="comm" value="${comm}"></textarea>
					<span class="focus-input100"></span>
				</div>
				...
				<div class="container-contact100-form-btn">
					<div class="wrap-contact100-form-btn">
						...
						<button class="contact100-form-btn" type = "submit" name = "action"  value = "confModVoy">
							<span>
								Modifier
